...
int tpbujie = 5; // timp mentinere pornita bujie (s)
...
for (int i = 1; i<=tpbujie; i++)
{
  analogWrite(ventilator, 255*i/tpbujie);  // crestere turatie pompita
  Serial.print("Turatie ventilator: ");
  Serial.print(255*i/tpbujie);
  Serial.println("/255");
