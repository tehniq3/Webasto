...
// versiune 2, schimbare functionare, versiune Marius Sinescu
...
int tppompa1 = 150;  // timp alimentare pompa la aprindere
int tppompa2 = 1850; // timp alimentare pompa la functionare normala
...
void setup() {
Serial.begin(9600);
Serial.println("Simulare control Webasto v.2.0");
...
delay(3000); // mica pauza

Serial.println("---------------------------------");
Serial.println("Se initializeaza procedura de aprindere !");
// 2) alimentare bujie, pompa alimentata cu 3 impulsuri scurte, apoi o data la 2 secunde, turatie ventilator scazuta
